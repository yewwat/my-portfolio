...
export const aboutData = {
  img: 'profile.jpg',
  paragraphOne:
    'สวัสดีครับ ผมวัชรากร แท่นแก้ว หรือเรียกว่า "ยิว" ก็ได้นะครับ ตอนนี้กำลังเรียนอยู่ปีที่ 3 คณะวิศวกรรมศาสตร์ สาขาวิศวกรรมคอมพิวเตอร์ ที่สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง(สจล.)',
  paragraphTwo:
    'สนใจงานด้าน UX/UI design และ Front-end development ชอบใช้ความคิดสร้างสรรค์ และการพัฒนา Software ให้ออกมาดูดี',
  paragraphThree: '',
